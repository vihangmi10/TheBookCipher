...
public final class Decryption extends Application {
 
    public static String enc_txt;
    public static String ref_key;
    private Desktop desktop = Desktop.getDesktop();
  private static final Image ICON_48 = new Image(Decryption.class.getResourceAsStream("icon-48x48.png"));
    @Override
...
// scene.getStylesheets().add
 //(TestingFileOPen.class.getResource("Login.css").toExternalForm());
        ...
        Label userName = new Label("CipherText :");
        ...
        userTextField.setPromptText("Enter encrypted file");
      ...
      // Button encrypt = new Button("ENCRYPT");
        Button decrypt = new Button(" ", imageView);
       decrypt.setContentDisplay(ContentDisplay.LEFT);
        
        GridPane.setConstraints(decrypt,1, 4);
        grid.getChildren().add(decrypt);
           decrypt.setStyle("-fx-base: red;");
         ...
         decrypt.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                if(!userTextField.getText().matches("") && !lastName.getText().matches("") )
                {
                    ...
                    {
                        enc_txt=userTextField.getText();
                        ref_key=lastName.getText();
                        
                        
                        stage.hide();
                        Thanks2 ds1 = new Thanks2();
              try {
                       ds1.start(stage);
              } catch (Exception ex) {
 ...
 //(TestingFileOPen.class.getResource("Login.css").toExternalForm());
    ...
    private void openFile(File file) {
        try {
            ...
            Logger.getLogger(Decryption.class.getName()).log(
                Level.SEVERE, null, ex
            );
        }
    }
    public String encrypt_text(String encr_txt){
       return encr_txt;
    }
